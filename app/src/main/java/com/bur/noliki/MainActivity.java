...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView playerName1TextView, playerName2TextView;
    ...
    FirebaseDatabase database = FirebaseDatabase.getInstance("https://noliki-default-rtdb.europe-west1.firebasedatabase.app/");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerName1TextView = findViewById(R.id.playerName1TextView);
        playerName2TextView = findViewById(R.id.playerName2TextView);
        ...
        getPlayerName = getIntent().getStringExtra("playerName");
        ...
        progressDialog.setMessage("Ожидание оппонента");
        progressDialog.show();

        playerUniqueId = String.valueOf(System.currentTimeMillis());

        playerName1TextView.setText(getPlayerName);
                            ...
                            if (status.equals("waiting")) {
                                if (getPlayerCount == 2) {
                                    ...
                                    for (DataSnapshot players : connections.getChildren()) {
                                        ...
                                        if (getPlayerUniqueId.equals(playerUniqueId)) {
                                            ...
                                            playerName2TextView.setText(getOpponentPlayerName);
                                            connectionsId = conId;
                                            opponentFound = true;

                                            databaseReference.child("turns").child(connectionsId).addValueEventListener(turnsEventListener);
                                            databaseReference.child("won").child(connectionsId).addValueEventListener(wonEventListener);
                                ...
                                if (getPlayerCount == 1) {
                                    ...
                                    for (DataSnapshot players : connections.getChildren()) {
                                        ...
                                        playerName2TextView.setText(getOpponentName);
                                        connectionsId = conId;
                                        opponentFound = true;
        ...
        wonEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild("player_id")) {
                    ...
                    databaseReference.child("turns").child(connectionsId).removeEventListener(turnsEventListener);
                    databaseReference.child("won").child(connectionsId).removeEventListener(wonEventListener);
                }
            }
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("1") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("1");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("2") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("2");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("3") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("3");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("4") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("4");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("5") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("5");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("6") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("6");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("7") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("7");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("8") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("8");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
        ...
        image9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!doneBoxes.contains("9") && playerTurn.equals(playerUniqueId)) {
                    ((ImageView) v).setImageResource(R.drawable.krestic);
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("box_position").setValue("9");
                    databaseReference.child("turns").child(connectionsId).child(String.valueOf(doneBoxes.size() + 1)).child("player_id").setValue(playerUniqueId);
    ...
    private void applyPlayerTurn(String PlayerUniqueId2) {
        if (PlayerUniqueId2.equals(playerUniqueId)) {
            player1Layout.setBackgroundResource(R.drawable.round_back_purple_stroke);
            player2Layout.setBackgroundResource(R.drawable.round_back_blue);
        } else {
            player2Layout.setBackgroundResource(R.drawable.round_back_blue_stroke);
            player1Layout.setBackgroundResource(R.drawable.round_back_purple);
        }
    }
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, String selectedByPlayer) {
        ...
        if (selectedByPlayer.equals(playerUniqueId)) {
            imageView.setImageResource(R.drawable.krestic);
            playerTurn = opponentUniqueId;
        } else {
        ...
        applyPlayerTurn(playerTurn);
        if (cheakPlayerWin(selectedByPlayer)) {
            databaseReference.child("won").child(connectionsId).child("player_id").setValue(selectedByPlayer);
        }
        if (doneBoxes.size() == 9) {
    ...
    private boolean cheakPlayerWin(String playerId) {
